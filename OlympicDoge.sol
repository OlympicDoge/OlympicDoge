 ...
 * Telegram:  https://t.me/OlympicDogeBsc 

 * Website: https://olympicdoge.finance
*/
...
contract OlympicDogeBsc is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("OlympicDogeBsc", "OlympicDoge") {
        ...
        maxBuyAmount = totalSupply / 1; // 0.50% maxTransactionAmountTxn
        maxSellAmount = totalSupply / 1; // 1% maxTransactionAmountTxn
        maxWalletAmount = totalSupply * 100 / 100; // 1% maxWallet
        thresholdSwapAmount = totalSupply * 5 / 10000; // 0.01% swap wallet
        ...
        marketingWallet = address(0x7DF8af89cA6c34e817838be21Fc5e91CD8A83C06);
        contestAIWallet = address(0x1d070aCab995B7EA1A0f8AE3140F5BC38A4AB322);
